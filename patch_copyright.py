...
def apply_pure_omp3_math(filepath="src/mp3/mp3.cc"):
    ...
    pure_math_code = """void OMP3::build_opdm_alpha() {
...
void OMP3::build_generalized_fock() {
    ...
    if (is_restricted) {
        ...
        // T_eff (Lambda Z-vector separable response) = T2 + 2 * T3
    ...
    new_content = content[:start_idx] + pure_math_code + "\n" + content[end_idx:]
    
    with open(filepath, 'w') as file:
        file.write(new_content)
        
    print("[+] Super Wipe-and-Replace BERHASIL! Mode komputasi matematis yang murni telah diinjeksi.")

if __name__ == "__main__":
    apply_pure_omp3_math()