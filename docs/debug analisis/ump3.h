...
private:
    ...
    Eigen::Tensor<double, 4> W_ovov_ab_;  ///< <mb|ej> α-occ × β-vir
    Eigen::Tensor<double, 4> W_ovov_ba_;  ///< <mb|ej> β-occ × α-vir
    Eigen::Tensor<double, 4> W_vvvv_ab_;  ///< <ab|ef> α-vir × β-vir
    ...
    void build_W_ovov_ab();
    void build_W_ovov_ba();
    void build_W_vvvv_ab();
    
    void compute_t2_2nd();
    void compute_t2_aa_2nd();
    void compute_t2_bb_2nd();
    void compute_t2_ab_2nd();
    ...
    double compute_ring_contribution();
    double compute_hole_ladder_contribution();
    double compute_particle_ladder_contribution();
};
