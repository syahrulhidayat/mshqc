...
class SACASConfig:
    ...
    weights: List[float]         # <--- Tambahkan
    e_thresh: float              # <--- Tambahkan
    grad_thresh: float           # <--- Tambahkan
    print_level: int             # <--- Tambahkan
    rotation_damping: float      # <--- Tambahkan
    shift: float                 # <--- Tambahkan
    def __init__(self) -> None: ...
