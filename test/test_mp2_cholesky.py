...
# =====================================================================
# 2. PARAMETER GLOBAL (KHUSUS CHOLESKY & MP2)
# =====================================================================
BASIS_NAME = "cc-pVTZ"
THRESHOLD  = 1e-9
...
def run_mshqc_bench(sys_name, atoms, chg, mult, ref, basis_name, mp2_algo):
    ...
    # Pengaturan Spesifik Cholesky
    scf_conf.use_df = False
    scf_conf.cholesky_threshold = THRESHOLD 
    ...
    # Pengaturan Spesifik Cholesky (diteruskan dari SCF)
    mp2_conf.use_df = False
    mp2_conf.cholesky_threshold = THRESHOLD 
...
def main():
    print("=========================================================================================")
    print(f"  MSHQC ONLY | PERFORMANCE PROFILING TEST (CHOLESKY - MP2 ONLY)")
