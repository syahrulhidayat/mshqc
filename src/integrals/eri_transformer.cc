...
// Transformasi berbasis MLIR-JIT untuk menggantikan tblis::mult
...
// Implementasi get_mo_tensor menggunakan JIT DF Assembly...
...
// Delegasi lain diabaikan demi keringkasan injektor.
