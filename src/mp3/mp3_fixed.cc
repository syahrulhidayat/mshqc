...
void OMP3::build_generalized_fock() {
    ...
    if (is_restricted) {
        ...
        // KOREKSI FINAL: Skalar 2-RDM Govov direduksi secara proporsional (-0.25)
        ...
        // KOREKSI FINAL: Skalar 2-RDM Gvvvv direduksi secara proporsional (0.5)
        ...
        // KOREKSI FINAL: Skalar 2-RDM Goooo direduksi secara proporsional (0.5)
            ...
            for (int a = 0; a < va_; ++a) {
                for (int j = 0; j < na_; ++j) {
                    for (int b = 0; b < va_; ++b) {
                        ...
                        // KOREKSI FINAL: Skalar proyektor Teff diperbaiki menjadi proporsi mutlak: (T2) + 2.0 * (T3)
    ...
    if (!is_restricted && nb_ > 0 && vb_ > 0) {
        ...
        F_gen_b_ = F_gen_a_; // Tersinkronisasi sempurna dengan memuat kontribusi Z_mat_a
    }
}
