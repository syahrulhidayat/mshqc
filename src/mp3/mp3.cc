...
void OMP3::build_generalized_fock() {
    ...
    if (is_restricted) {
        ...
        // KOREKSI FINAL: Indeks TBLIS Aman & Skalar Spatial Eksak
        ...
        if (nb_ > 0 && vb_ > 0) {
            ...
            // KOREKSI FINAL: Indeks TBLIS 100% Simetris & Aman Memori (HPC Safe)
    ...
    // KOREKSI FINAL: Skalar Z-Vector Eksak -4.0 (Tarik 2.0 dari F_pq, 2.0 dari Asimetri w_ai)
    ...
    // KOREKSI FINAL: Skalar Z-Vector Eksak +4.0
    ...
    // KOREKSI FINAL: Skalar Z-Vector Eksak Y (-4.0 dan +4.0)
    ...
    if (!is_restricted && nb_ > 0 && vb_ > 0) {
        ...
        tblis::mult<double>(-4.0, t_Gvvvv_ab_s, "cdab", t_Bvv_a, "cdP", 1.0, t_Xvv_b, "abP"); 
        ...
        tblis::mult<double>( 4.0, t_Goooo_ab_s, "klij", t_Boo_a, "klP", 1.0, t_Xoo_b, "ijP"); 
        ...
        tblis::mult<double>(-4.0, t_Y_bb, "amP", t_Boo_b, "miP", 1.0, t_Zb, "ai");
        tblis::mult<double>( 4.0, t_Y_bb, "eiP", t_Bvv_b, "aeP", 1.0, t_Zb, "ai");
