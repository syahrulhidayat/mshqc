...
void OMP3::build_generalized_fock() {
    ...
    if (is_restricted) {
        ...
        compute_gamma_res(t_T2t, t_Taa, 0.5);  
        ...
        compute_gamma_aa(t_Taa, t_Taa, 0.5); 
        ...
        if (nb_ > 0 && vb_ > 0) {
            ...
            compute_gamma_bb(t_Tbb, t_Tbb, 0.5); 
            ...
            compute_gamma_ab(t_Taa, t_Tbb, t_Tab, t_Taa, t_Tbb, t_Tab, 0.5); 
