...
void OMP3::build_opdm_alpha() {
    ...
    if (is_restricted) {
        ...
        // FIX: T2/MP3 cross terms scaled by 0.5 relative to MP2
...
void OMP3::build_generalized_fock() {
    ...
    if (is_restricted) {
        ...
        // FIX: Evaluasi T1*T1 saja (Tanpa L2/T3) karena derivatif eksplisit MP3 W hanya butuh T1
