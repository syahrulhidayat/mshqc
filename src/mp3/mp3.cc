...
void OMP3::build_generalized_fock() {
    ...
    if (is_restricted) {
        ...
        tblis::mult<double>(-0.25, t_T2t, "imae", t_Taa, "jmeb", 1.0, t_Govov_aa, "iajb");
        tblis::mult<double>(-0.25, t_T2t, "mjea", t_Taa, "mibe", 1.0, t_Govov_aa, "iajb");
        tblis::mult<double>(0.125, t_T2t, "mjea", t_Taa, "miba", 1.0, t_Govov_aa, "iajb");
        tblis::mult<double>(0.125, t_T2t, "imae", t_Taa, "jmba", 1.0, t_Govov_aa, "iajb");
