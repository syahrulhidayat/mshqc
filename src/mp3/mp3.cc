...
void OMP3::build_opdm_alpha() {
    ...
    if (is_restricted) {
        ...
        tblis::mult<double>(-2.0, t_T2, "ikab", t_L2t, "jkab", 1.0, t_Goo, "ij"); 
        tblis::mult<double>(-2.0, t_L2, "ikab", t_T2t, "jkab", 1.0, t_Goo, "ij");

        tblis::mult<double>(1.0,  t_T2, "ijac", t_T2t, "ijbc", 0.0, t_Gvv, "ab");
        tblis::mult<double>(2.0, t_T2, "ijac", t_L2t, "ijbc", 1.0, t_Gvv, "ab"); 
        tblis::mult<double>(2.0, t_L2, "ijac", t_T2t, "ijbc", 1.0, t_Gvv, "ab");
    ...
    tblis::mult<double>(-1.0, t_T2aa, "ikab", t_T3aa, "jkab", 1.0, t_Goo_a, "ij"); 
    tblis::mult<double>(-1.0, t_T3aa, "ikab", t_T2aa, "jkab", 1.0, t_Goo_a, "ij");
    
    tblis::mult<double>(0.5,   t_T2aa, "ijac", t_T2aa, "ijbc", 1.0, t_Gvv_a, "ab");
    tblis::mult<double>(1.0, t_T2aa, "ijac", t_T3aa, "ijbc", 1.0, t_Gvv_a, "ab");
    tblis::mult<double>(1.0, t_T3aa, "ijac", t_T2aa, "ijbc", 1.0, t_Gvv_a, "ab");
    if (!is_restricted && nb_ > 0 && vb_ > 0) {
        auto* t2_ab_dense = t2_ab_.get_block(0,0,0,0);
        ...
        tblis::mult<double>(-2.0, t_T2ab, "ikab", t_T3ab, "jkab", 1.0, t_Goo_a, "ij");   
        tblis::mult<double>(-2.0, t_T3ab, "ikab", t_T2ab, "jkab", 1.0, t_Goo_a, "ij");
        
        tblis::mult<double>(1.0,  t_T2ab, "ijac", t_T2ab, "ijbc", 1.0, t_Gvv_a, "ab");
        tblis::mult<double>(2.0, t_T2ab, "ijac", t_T3ab, "ijbc", 1.0, t_Gvv_a, "ab"); 
        tblis::mult<double>(2.0, t_T3ab, "ijac", t_T2ab, "ijbc", 1.0, t_Gvv_a, "ab");
    }
}
void OMP3::build_opdm_beta() {
    ...
    tblis::mult<double>(-1.0, t_T2bb, "ikab", t_T3bb, "jkab", 1.0, t_Goo_b, "ij");
    tblis::mult<double>(-1.0, t_T3bb, "ikab", t_T2bb, "jkab", 1.0, t_Goo_b, "ij");
    
    tblis::mult<double>(0.5,   t_T2bb, "ijac", t_T2bb, "ijbc", 1.0, t_Gvv_b, "ab");
    tblis::mult<double>(1.0, t_T2bb, "ijac", t_T3bb, "ijbc", 1.0, t_Gvv_b, "ab");
    tblis::mult<double>(1.0, t_T3bb, "ijac", t_T2bb, "ijbc", 1.0, t_Gvv_b, "ab");
    
    tblis::mult<double>(-1.0,  t_T2ab, "kiab", t_T2ab, "kjab", 1.0, t_Goo_b, "ij");
    tblis::mult<double>(-2.0, t_T2ab, "kiab", t_T3ab, "kjab", 1.0, t_Goo_b, "ij"); 
    tblis::mult<double>(-2.0, t_T3ab, "kiab", t_T2ab, "kjab", 1.0, t_Goo_b, "ij");
    
    tblis::mult<double>(1.0,  t_T2ab, "ijca", t_T2ab, "ijcb", 1.0, t_Gvv_b, "ab");
    tblis::mult<double>(2.0, t_T2ab, "ijca", t_T3ab, "ijcb", 1.0, t_Gvv_b, "ab");
    tblis::mult<double>(2.0, t_T3ab, "ijca", t_T2ab, "ijcb", 1.0, t_Gvv_b, "ab");
}
...
void OMP3::build_generalized_fock() {
    ...
    // 1. Explicit MP3 (T2 * T2) - KOREKSI SKALA & SPIN-ADAPTATION
    ...
    if (is_restricted) {
        ...
        // Gunakan T2t yang ter-adaptasi secara sempurna
        ...
        // Skala UMP3 diubah menjadi murni 2.0 * Gamma_true
    ...
    if (!is_restricted && nb_ > 0 && vb_ > 0) {
        ...
        tblis::mult<double>(2.0, t_Tab, "ijac", t_Tab, "ijbd", 1.0, t_Gvvvv_ab, "abcd");
        tblis::mult<double>(2.0, t_Tab, "ikab", t_Tab, "jlab", 1.0, t_Goooo_ab, "ijkl");
