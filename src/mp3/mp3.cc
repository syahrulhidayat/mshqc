...
void OMP3::build_generalized_fock() {
    ...
    if (is_restricted) {
        ...
        // KOREKSI FINAL: Indeks TBLIS yang Dieksakkan & Tanda Govov Positif Dominan
        auto compute_gamma_res = [&](auto& t_T, auto& t_Tt, double scale) {
            tblis::mult<double>( 1.0*scale, t_Tt, "ijab", t_T, "ijcd", 1.0, t_Gvvvv_aa, "abcd"); // KANONIKAL abcd
            tblis::mult<double>( 1.0*scale, t_Tt, "ijab", t_T, "klab", 1.0, t_Goooo_aa, "ijkl"); // KANONIKAL ijkl
            tblis::mult<double>( 2.0*scale, t_Tt, "ikac", t_T, "jkbc", 1.0, t_Govov_aa, "iajb"); // KANONIKAL iajb
            tblis::mult<double>( 2.0*scale, t_Tt, "kjcb", t_T, "kiac", 1.0, t_Govov_aa, "iajb"); 
            tblis::mult<double>(-1.0*scale, t_Tt, "kjcb", t_T, "kica", 1.0, t_Govov_aa, "iajb"); 
        ...
        auto compute_gamma_aa = [&](auto& t_Tleft, auto& t_Tright, double scale) {
            tblis::mult<double>( 0.125*scale, t_Tleft, "ijab", t_Tright, "ijcd", 1.0, t_Gvvvv_aa, "abcd"); // KANONIKAL abcd
            tblis::mult<double>( 0.125*scale, t_Tleft, "ijab", t_Tright, "klab", 1.0, t_Goooo_aa, "ijkl"); // KANONIKAL ijkl
            tblis::mult<double>(-0.25*scale,  t_Tleft, "mkcb", t_Tright, "mkca", 1.0, t_Govov_aa, "iajb"); // KANONIKAL iajb
        };
        ...
        if (nb_ > 0 && vb_ > 0) {
            ...
            auto compute_gamma_bb = [&](auto& t_Tleft, auto& t_Tright, double scale) {
                tblis::mult<double>( 0.125*scale, t_Tleft, "ijab", t_Tright, "ijcd", 1.0, t_Gvvvv_bb, "abcd"); // KANONIKAL abcd
                tblis::mult<double>( 0.125*scale, t_Tleft, "ijab", t_Tright, "klab", 1.0, t_Goooo_bb, "ijkl"); // KANONIKAL ijkl
                tblis::mult<double>(-0.25*scale,  t_Tleft, "mkcb", t_Tright, "mkca", 1.0, t_Govov_bb, "iajb"); // KANONIKAL iajb
            };
            ...
            auto compute_gamma_ab = [&](auto& t_Ta_L, auto& t_Tb_L, auto& t_Tab_L,
                ...
                tblis::mult<double>( 1.0*scale, t_Tab_L, "ijab", t_Tab_R, "ijcd", 1.0, t_Gvvvv_ab, "abcd"); // KANONIKAL abcd
                tblis::mult<double>( 1.0*scale, t_Tab_L, "ijab", t_Tab_R, "klab", 1.0, t_Goooo_ab, "ijkl"); // KANONIKAL ijkl

                tblis::mult<double>(-0.5*scale, t_Tab_L, "mkca", t_Tab_R, "mkcb", 1.0, t_Govov_bb, "iajb"); // KANONIKAL iajb
                tblis::mult<double>(-0.5*scale, t_Ta_L,  "mkca", t_Tab_R, "mkcb", 1.0, t_Govov_ab, "iajb"); // KANONIKAL iajb
                tblis::mult<double>(-0.5*scale, t_Tab_L, "imac", t_Tb_R,  "jmbc", 1.0, t_Govov_ab, "iajb"); // KANONIKAL iajb
                tblis::mult<double>(-0.5*scale, t_Tab_L, "imac", t_Tab_R, "jmbc", 1.0, t_Govov_aa, "iajb"); // KANONIKAL iajb
            };
