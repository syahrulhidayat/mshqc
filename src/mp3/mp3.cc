...
void OMP3::build_generalized_fock() {
    ...
    if (is_restricted) {
        ...
        // ====================================================================
        // REVISI BLOK RESTRICTED (is_restricted == true)
        // ====================================================================
        ...
        tblis::mult<double>(1.0, t_T2t, "ilab", t_Taa, "knab", 0.0, t_Goooo_a, "ikln");
        ...
        // ====================================================================
        // REVISI BLOK UNRESTRICTED (is_restricted == false)
        // ====================================================================
