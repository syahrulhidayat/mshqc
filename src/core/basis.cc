...
// MSHQC - Basis Set Implementation (Aligned for MLIR-JIT SIMD Vectorization)
// ==============================================================================
...
std::vector<int, runtime::AlignedAllocator<int, 64>> BasisSet::shell_to_basis_function_map() const {
    std::vector<int, runtime::AlignedAllocator<int, 64>> map;
    int bf_index = 0;
