/**
 * @file rmp3_h2_ccpvdz_test.cc
 * @brief RMP3 test on H2 with cc-pVDZ basis (closed-shell)
 */
...
int main() {
    ...
    BasisSet basis("cc-pVDZ", h2);
    std::cout << "Basis: cc-pVDZ (" << basis.n_basis_functions() << " functions)\n";
