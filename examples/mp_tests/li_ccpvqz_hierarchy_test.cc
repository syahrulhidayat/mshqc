...
int main() {
    std::cout << "\n========================================\n";
    std::cout << "  Li MPn Hierarchy: cc-pVQZ\n";
    std::cout << "  Testing UMP2 → UMP3 → UMP4\n";
    std::cout << "========================================\n\n";
    ...
    std::cout << "\nTotal energies:\n";
    std::cout << "  E(UMP2):         " << std::setw(16) << (e_uhf + e2) << " Ha\n";
    std::cout << "  E(UMP3):         " << std::setw(16) << (e_uhf + e2 + e3) << " Ha\n";
    std::cout << "  E(UMP4-SDQ):     " << std::setw(16) << (e_uhf + e2 + e3 + e4_s) << " Ha\n\n";
