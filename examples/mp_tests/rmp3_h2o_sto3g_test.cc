/**
 * @file rmp3_h2o_sto3g_test.cc
 * @brief Fast RMP3 test on H2O with STO-3G basis
 *
 * Intended to validate RMP3 pipeline quickly (O(N^6) manageable at this size).
 */
