...
# ==============================================================================
# MSHQC Full Installer (With OpenBLAS Support)
...
echo "Menginstall: cmake, eigen, libint, boost, openblas..."

# [UPDATE] Menambahkan 'openblas' dan 'pkg-config'
...
rm -rf build/ dist/ *.egg-info mshqc.egg-info _skbuild
...
# [UPDATE] Flag kompilasi lengkap untuk OpenBLAS & Eigen
export CXXFLAGS="-std=c++17 -fopenmp -O3 -DEIGEN_USE_BLAS -DEIGEN_USE_LAPACKE"

# [UPDATE] Mencegah hang saat instalasi/verifikasi
